...
\section{Einleitung}
RFID Technik ist in vielen Anwendungen zu finden, dessen Sicherheit zum Teil auf der korrekten Funktionsweise dieser Technik beruht. Den Preis den man für den erhöhten Komfort durch die kontaktlose Technik zahlt ist in vielen Fällen ein signifikant verringertes Sicherheitsniveau oder eine Einschränkung der Privatsphäre. Aus diesem Grund muss bei der Verwendung von RFID Technologie  ein besonderes Augenmerk auf die Sicherheit dieses Systems gelegt werden und es muss durch geeignete Schutzmaßnahmen dafür gesorgt werden, dass sicherheitskritische Systembereiche, die auf RFID Technologie beruhen, abgesichert werden.

Die Arbeit ist wie folgt gegliedert. In Abschnitt 3 werden die Grundlagen der RFID und die darauf aufbauende NFC Technik erläutert. (WORK IN PROGRESS)

\section{Grundlagen}

\subsection{RFID Technik}
Radio Frequency Identification (RFID) ist eine Technik um kontaktlos Daten mittels eines Lesegerätes (Transceiver) aus einem Transponder auszulesen. Transponder gibt es in vielen verschiedenen Formen und Größen, je nach Anwendungsbereich. Grundlegend unterscheidet man bei RFID Transpondern zwischen passiven und aktiven Transpondern. 

Passive Transponder besitzen keine eigene Spannungsquelle. Sie bestehen aus einer Antenne, in Form einer Spule, Schaltkreisen zum Senden/Empfangen und einen Speicher. Über die spulenförmig angeordnete Antenne wird mittels des Lesegerätes eine Spannung induziert, welche den Transponder mit dem nötigen Strom versorgt um seine Informationen an das Lesegerät zu übermitteln.

Aktive Transponder hingegen sind relativ ähnlich aufgebaut, jedoch besitzen diese zusätzlich noch eine eingebaute Spannungsquelle, meist in Form einer Batterie. Durch den Einsatz einer Batterie ist es dem Transponder möglich größere Distanzen zu überbrücken als der passive Transponder und 
